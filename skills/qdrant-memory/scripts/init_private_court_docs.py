#!/usr/bin/env python3
"""
Initialize private_court_docs collection (Court Documents)
Vector size: 1024 (snowflake-arctic-embed2)

Usage: init_private_court_docs.py [--recreate]
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Initialize private_court_docs collection")
